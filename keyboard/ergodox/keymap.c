...
static const uint8_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    KEYMAP(  // layer 1 : regular numbers, and some minor utility stuff
        // left hand
        TRNS,INV1,INV2,INV3,INV4,INV5,L0,
        ...
        TRNS,TRNS,TRNS,TRNS,TRNS,
                                 ...
                                 TRNS,TRNS,TRNS,
        // right hand
             TRNS,INV6,INV7,INV8,INV9,INV0,TRNS,
             TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TLDE,
                  TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,
             TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,
    ...
    KEYMAP(  // layer 2 : f-keys, numpad, media keys, misc
        ...
        TRNS,TRNS,TRNS,TRNS,TRNS,
                                 ...
                                 TRNS,TRNS,TRNS,
        // right hand
             L0,  F6,  F7,  F8,  F9,  F10, F11, 
             TRNS,PAST,P7,  P8,  P9,  NLCK,VOLU,
                  PPLS,P4,  P5,  P6,  TRNS,VOLD,
             TRNS,PMNS,P1,  P2,  P3,  PSLS,MUTE,
